...
import { BookOpen, Trophy, Users, ArrowRight, Clock, Calendar } from "lucide-react";
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${activity.gradient} opacity-30`}></div>
                  
                  {/* Floating Icon */}
                  <div className={`absolute top-6 left-6 w-14 h-14 bg-gradient-to-br ${activity.gradient} rounded-2xl flex items-center justify-center shadow-glow backdrop-blur-sm border border-white/20 group-hover:scale-110 transition-transform duration-300`}>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="space-y-4 mb-8">
                    {activity.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-start space-x-3 group/item">
                        <div className={`w-6 h-6 rounded-lg bg-gradient-to-br ${activity.gradient} flex items-center justify-center flex-shrink-0 group-hover/item:scale-110 transition-transform duration-200`}>
                  ...
                  {/* CTA Button */}
                  <Button 
                    className={`w-full bg-gradient-to-r ${activity.gradient} hover:opacity-90 text-white border-0 shadow-glow hover:shadow-glow-lg transition-all duration-300 group-hover:scale-105`}
                  >
        ...
        <div className="mt-24">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Các hoạt động thường xuyên giúp sinh viên phát triển kỹ năng và chuẩn bị cho tương lai
            </p>
          </div>
